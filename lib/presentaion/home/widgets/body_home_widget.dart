...
import 'package:task_systel/presentaion/home/bloc/event.dart';
import 'package:task_systel/presentaion/home/bloc/state.dart';
              ...
              child: Column(
                children: [
                  ...
                  MediaQuery.removeViewPadding(
                      context: context,
                      child: const CardsWalletPaymentWidget()),
                  const SizedBox(
                    height: AppSize.s30,
                  ),
              ...
              child: state is LoadingHomeState
                  ? const Center(
                      child: CircularProgressIndicator(
                        color: ColorManager.ligthPrimary,
                      ),
                    )
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) => Padding(
                        ...
                        child: CardUserDetailsWidget(
                          username: LocalDataSource.usersName[index]
                              ["username"],
